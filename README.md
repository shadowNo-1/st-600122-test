...
- **量化宽松（QE）背景下的风险透视**：本次违约并非孤立事件，其发生时机和性质深受前期量化宽松政策周期的影响。在QE营造的流动性充裕环境中，市场风险偏好上升，信用利差收窄，这使得像ST宏图这样基本面持续恶化的企业仍能维持融资渠道，甚至可能通过“借新还旧”延迟实质性违约的时点。然而，这种宽松的融资环境并未用于改善其核心业务的造血能力，反而掩盖了真实的财务脆弱性。当宏观流动性环境边际收紧或市场对其个体风险进行重估时，长期积累的偿付能力危机便会加速暴露。2025年中的这起违约，正是其依赖外部流动性“续命”的模式不可持续的最终证明。从审计角度看，在QE周期中，对高负债企业的审计必须穿透其融资表象，重点审视债务资金的真实用途、现金流与利润的匹配度，以及管理层在偿债安排上的激进假设，警惕宽松货币环境所催生的“僵尸化”风险。

```mermaid
flowchart TD
    subgraph A [宏观起点：量化宽松政策]
        direction LR
        A1[流动性泛滥]
        A2[资产价格上涨]
        A3[风险偏好上升]
    ...
    subgraph B [风险传导与放大]
        B1[“治理风险<br>粉饰报表动机增强”]
        B2[“经营风险<br>转型压力被延迟”]
        B3[“财务风险<br>融资依赖不可持续模式”]
        B4[“环境风险<br>退市与诉讼压力积聚”]
    end

    subgraph C [ST宏图的具体风险表现]
        C1[“被证监会立案调查<br>信息披露违规”]
        C2[“核心业务收入腰斩<br>持续经营能力存疑”]
        C3[“公开债务实质性违约<br>流动性枯竭”]
        C4[“被实施*ST<br>面临投资者诉讼”]
    end
